...
def main(args: list[str]) -> None:
    ...
    if args.command == "fetch":
        ...
        if args.target == "classification":
            ...
            metrics_dir = config["results"]["classification_w_mod_code_Larger_MLP_w_Dropout"]
            ...
            for i in range(args.num_runs):
                ...
                metric_dir = f"results/reporting/summarization_higher_samp_w_proj_high_IA3/summarization_rouge_results_run_{i+1}.json"
